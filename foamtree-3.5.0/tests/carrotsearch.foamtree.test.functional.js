describe("FoamTree", foamtreeTest(function() {
  ...
  cube(
    ...
    {
      "configured with hi-fi switch": function() {
        options.wireframeDrawMaxDuration = 0;
      },
      "configured without hi-fi switch": function() {
        options.wireframeDrawMaxDuration = 100000;
      }
    },
  ...
  cube(
    ...
    {
      "configured with hierarchical stacking": function() {
        options.stacking = "hierarchical";
      },
      "configured with flattened stacking and stab description group": function() {
        options.stacking = "flattened";
        options.descriptionGroupType = "stab";
      },
      "configured with flattened stacking and floating description group": function() {
        options.stacking = "flattened";
        options.descriptionGroupType = "floating";
      }
    },
    {
