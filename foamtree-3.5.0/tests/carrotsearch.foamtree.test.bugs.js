describe("FoamTree", foamtreeTest(function () {
  ...
  describe("should not fail", function () {
    it("when groups are set to be exposed in dataObject and relaxation is to be visible", sinon.test(function () {
      ...
      expect(foamtree.get("state", "1.1").exposed).to.be.true;
    }));
